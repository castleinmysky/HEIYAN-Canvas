...
- Supports model and reasoning controls, image input, project memory, history search, node editing, approved generation and result inspection. The current standalone Codex connector is 1.6.1. See the [1.2.1 release notes](releases-1.2.1.md).
