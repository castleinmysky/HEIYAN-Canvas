...
try {
  $files = @('LICENSE', 'server/agent-connector.js', 'server/agent-contract.js', 'server/agent-capabilities.js', 'server/agent-questions.js', 'server/agent-version.js', 'server/codex-runtime.js', 'scripts/start-agent-connector.mjs')
