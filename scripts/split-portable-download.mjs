...
const [archive, destination, version = '1.6.0'] = process.argv.slice(2);
...
await fs.writeFile(path.join(destination, 'manifest.json'), JSON.stringify({ filename: 'HEIYAN-Connector-Windows-x64.zip', platform: 'win32-x64', version, bytes, sha256, parts }, null, 2) + '\n');
