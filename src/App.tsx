...
function Studio() {
  ...
  const agentItems = useMemo<CanvasAgentItem[]>(() => !agentOpen ? [] : nodes.map((node) => {
  ...
  const referenceGraphSignatures = useMemo(() => canvasReferenceGraphSignatures(nodes, edges), [edges, nodes]);
